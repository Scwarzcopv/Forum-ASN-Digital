        ...
        <div class="p-3">
            <div class="row">
                ...
                <div class="col-12 col-sm-8 col-lg-9 my-auto closest">
                    ...
                    <div class="m-0 p-0">
                        <button type="button" class="btn fs-3 fw-bold m-0 p-0 border-0 text-primary text-start lh-1" data-id="<?= $row['agenda_rapat']; ?>" id="triggerModal"><?= $row['agenda_rapat']; ?></button>
                    </div>
