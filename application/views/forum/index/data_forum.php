...
<main class="">
    <article class="taget-box col-12 bg-dark mb-3 py-0 pe-0 ps-2 rounded-2">
        <div class="card border_radius-card mb-0" data-id="1">
            <div class="p-3">
                <div class="row">
                    <div class="mx-auto col-8 col-sm-2 col-lg-1 d-flex justify-content-center align-items-center pb-2 pb-sm-0 p-0 card-button cursor-pointer position-relative ">
